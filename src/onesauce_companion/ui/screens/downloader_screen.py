...
def _configure_downloads_table(table: QTableWidget) -> None:
    ...
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["component"], QHeaderView.ResizeMode.Fixed)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["type"], QHeaderView.ResizeMode.Fixed)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["available"], QHeaderView.ResizeMode.Fixed)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["downloaded"], QHeaderView.ResizeMode.Fixed)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["installed"], QHeaderView.ResizeMode.Fixed)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["size"], QHeaderView.ResizeMode.Fixed)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["status"], QHeaderView.ResizeMode.Stretch)
    header.setSectionResizeMode(DOWNLOADS_TABLE_COLUMNS["actions"], QHeaderView.ResizeMode.Fixed)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["component"], 300)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["type"], 170)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["available"], 140)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["downloaded"], 152)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["installed"], 140)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["size"], 110)
    table.setColumnWidth(DOWNLOADS_TABLE_COLUMNS["actions"], 192)
